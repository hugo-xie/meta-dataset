...
parser.add_argument('--base-path', default='', type=str, help='/path/to/records')
parser.add_argument('--gin-file-path', default='meta_dataset/learn/gin/setups/data_config.gin', 
                    type=str, help='gin file path')
